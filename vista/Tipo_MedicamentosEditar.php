...
<?php include('../dist/Plantilla.php');?>
    ...
    <div class="bg-white rounded h-25 p-4" style="width: 50%; margin:auto;">
                <center><h1>Editar tipo de medicamento</h1></center>
                ...
                <?php
                    require_once('../controlador/Tipo_MedicamentosController.php');
                        ...
                        if (isset($_GET['id'])) {
                        $tipo_medicamentoId = $_GET['id'];

                        // Obtener los datos del Rol con el ID proporcionado
                        $tipo_medicamento = $tipo_medicamentoscontroller->verPorId($tipo_medicamentoId);
                        ...
                        if (isset($_POST['nombre']) && isset($_POST['descripcion'])) {
                            ...
                            $tipo_medicamentoscontroller->modificar($tipo_medicamentoId, $nuevoNombre, $nuevoDescripcion);
                ...
                <form method="POST">
                    ...
                    <div class="form-floating mb-3">    
                        <input class="form-control" type="text" name="nombre" id="nombre" value="<?php echo $tipo_medicamento['nombre']; ?> "><br>
                    ...
                    <div class="form-floating mb-3">
                        <select class="form-select" name="valor" id="valor">
                            <?php if ($tipo_medicamento['valor'] == 1) {
                        ...
                        <label for="valor">Descripción de Tipo de Medicamento:</label>
                    
                    
                    <div class="form-floating mb-3">
                        <input class="form-control" type="text" name="descripcion" id="descripcion" value="<?php echo $tipo_medicamento['descripcion']; ?> "><br>
                        <label for="nombre">Descripcion:</label>
                    </div>

                    <div class="form-floating mb-3">
                        <button class="btn btn-outline-success" type="submit">Editar Tipo de Medicamento <i class="fa fa-check"></i></button>
