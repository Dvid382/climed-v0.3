...
$controlador = new Tipo_MedicamentosController();
$tipo_medicamentos = $controlador->verTodos();
?>
    ...
    <div class="content open">
        ...
        <div class="container-fluid pt-4 px-4">
            <div class="bg-light rounded h-100 p-4">
                <h2>Ver Todos los Tipo Medicamentos</h2>
                ...
                <div class="table-responsive">
                    ...
                    <br><a class="btn btn-outline-primary m-2" href="Tipo_MedicamentosCrear.php"><i class="fa fa-plus"></i> Nuevo Tipo de medicamento</a>
                    
                    <?php endif; ?>
                    <?php if($_SESSION['valor_rol'] == '1'): ?>
                                <a  class="btn btn-outline-primary m-2" href="Reporte_Tipo_Medicamentos.php">Imprimir lista <i class="fa-solid fa-file-pdf"></i></a>  
                    <?php endif;  ?>
                    ...
                    <table id="tabla" class="table table-bordered table-hover table-striped">
                            ...
                            <?php foreach($tipo_medicamentos as $tipo_medicamento): ?>
                            <tr>
                                <td><?php echo $tipo_medicamento['nombre']; ?></td>

                                

                                <td ><?php echo $tipo_medicamento['descripcion'];?></td>
                                ...
                                <?php if($_SESSION['valor_rol'] == '1'):?>
                                    ...
                                    <a  class="btn btn-outline-warning" href="Tipo_MedicamentosEditar.php?id=<?php echo $tipo_medicamento['id']; ?>"><i class="fa fa-pencil-alt"></i></a>
                                    <a class="btn btn-outline-danger" href="Tipo_MedicamentosEliminar.php?id=<?php echo $tipo_medicamento['id']; ?>"><i class="fa fa-trash-alt"></i></a>
                                <?php endif; ?>
...
<script>
        ...
        $.ajax({
            url: 'UnidadMedidasMenuEditar.php',
            type: 'GET',
            data: { id: id },
