     ...
     <?php
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if ($existepersonas) {
                ...
                $resultado = $personascontroller->InsertarPersonaCitas($nombre, $apellido, $cedula, $telefono, $correo, $sexo, $direccion, $f_nacimiento, $estatus,  $segundo_nombre, $segundo_apellido);
