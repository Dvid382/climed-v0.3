...
$controlador = new UnidadPesosController();
$unidadpesos = $controlador->verTodos();
?>
    ...
    <div class="content open">
        ...
        <div class="container-fluid pt-4 px-4">
            <div class="bg-light rounded h-100 p-4">
                <h2>Ver Todas las Unidades de peso</h2>
                ...
                <div class="table-responsive">
                    ...
                    <br><a class="btn btn-outline-primary m-2" href="UnidadPesosCrear.php"><i class="fa fa-plus"></i> Nueva Unidad de Peso</a>
                    
                    <?php endif; ?>
                    <?php if($_SESSION['valor_rol'] == '1'): ?>
                                <a  class="btn btn-outline-primary m-2" href="Reporte_UnidadPesos.php">Imprimir lista <i class="fa-solid fa-file-pdf"></i></a>  
                    <?php endif;  ?>
                    ...
                    <table id="tabla" class="table table-bordered table-hover table-striped">
                            ...
                            <?php foreach($unidadpesos as $unidadpesos): ?>
                            <tr>
                                <td><?php echo $unidadpesos['nombre']; ?></td>

                                

                                <td ><?php echo $unidadpesos['descripcion'];?></td>
                                ...
                                <?php if($_SESSION['valor_rol'] == '1'):?>
                                    ...
                                    <a  class="btn btn-outline-warning" href="UnidadPesosEditar.php?id=<?php echo $unidadpesos['id']; ?>"><i class="fa fa-pencil-alt"></i></a>
                                    <a class="btn btn-outline-danger" href="UnidadPesosEliminar.php?id=<?php echo $unidadpesos['id']; ?>"><i class="fa fa-trash-alt"></i></a>
                                <?php endif; ?>
