...
$controlador = new ComponentesActivosController();
$componentesactivos = $controlador->verTodos();
?>
    ...
    <div class="content open">
        ...
        <div class="container-fluid pt-4 px-4">
            <div class="bg-light rounded h-100 p-4">
                <h2>Ver Todos los Componentes Activos</h2>
                ...
                <div class="table-responsive">
                    ...
                    <br><a class="btn btn-outline-primary m-2" href="ComponentesActivosCrear.php"><i class="fa fa-plus"></i> Nueva Componentes Activos</a>
                    
                    <?php endif; ?>
                    <?php if($_SESSION['valor_rol'] == '1'): ?>
                                <a  class="btn btn-outline-primary m-2" href="Reporte_ComponentesActivos.php">Imprimir lista <i class="fa-solid fa-file-pdf"></i></a>  
                    <?php endif;  ?>
                    ...
                    <table id="tabla" class="table table-bordered table-hover table-striped">
                            ...
                            <?php foreach($componentesactivos as $componenteactivo): ?>
                            <tr>
                                <td><?php echo $componenteactivo['nombre']; ?></td>

                                

                                <td ><?php echo $componenteactivo['descripcion'];?></td>
                                ...
                                <?php if($_SESSION['valor_rol'] == '1'):?>
                                    ...
                                    <a  class="btn btn-outline-warning" href="ComponentesActivosEditar.php?id=<?php echo $componenteactivo['id']; ?>"><i class="fa fa-pencil-alt"></i></a>
                                    <a class="btn btn-outline-danger" href="ComponentesActivosEliminar.php?id=<?php echo $componenteactivo['id']; ?>"><i class="fa fa-trash-alt"></i></a>
                                <?php endif; ?>
...
<script>
        ...
        $.ajax({
            url: 'componenteactivoMenuEditar.php',
            type: 'GET',
            data: { id: id },
