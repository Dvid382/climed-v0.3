...
<?php include('../dist/Plantilla.php');?>
    ...
    <div class="bg-white rounded h-25 p-4" style="width: 50%; margin:auto;">
                <center><h1>Editar Unidad de Peso</h1></center>
                ...
                <?php
                    require_once('../controlador/UnidadPesosController.php');
                        ...
                        if (isset($_GET['id'])) {
                        $unidadpesosId = $_GET['id'];

                        // Obtener los datos del Rol con el ID proporcionado
                        $unidadpesos = $unidadpesoscontroller->verPorId($unidadpesosId);
                        ...
                        if (isset($_POST['nombre']) && isset($_POST['descripcion'])) {
                            ...
                            $unidadpesoscontroller->modificar($unidadpesosId, $nuevoNombre, $nuevoDescripcion);
                ...
                <form method="POST">
                    ...
                    <div class="form-floating mb-3">    
                        <input class="form-control" type="text" name="nombre" id="nombre" value="<?php echo $unidadpesos['nombre']; ?> "><br>
                    ...
                    <div class="form-floating mb-3">
                        ...
                        <label for="valor">Abreviatura:</label>
                    
                    
                    <div class="form-floating mb-3">
                        <input class="form-control" type="text" name="descripcion" id="descripcion" value="<?php echo $unidadpesos['descripcion']; ?> "><br>
                        <label for="nombre">Abreviatura:</label>
                    </div>

                    <div class="form-floating mb-3">
                        <button class="btn btn-outline-success" type="submit">Editar Unidad de Peso <i class="fa fa-check"></i></button>
