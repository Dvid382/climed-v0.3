...
<!--                 <div class="d-flex align-items-center ms-4 mb-4">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="Error404.php" class="nav-item nav-link"><i class="fa fa-gears me-2"></i>Gestion calidad.</a>
                    <a href="Error404.php" class="nav-item nav-link"><i class="fa fa-clipboard me-2"></i>Reportes.</a>
                    <a href="../controlador/cerrar_sesion.php" class="nav-item nav-link"><i class="fa fa-right-from-bracket me-2"></i>Cerrar sesion.</a>
