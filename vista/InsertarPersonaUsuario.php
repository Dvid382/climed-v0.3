...
<div class="container-sm pt-4 px-4">
     ...
     <?php
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if ($existepersonas) {
                ...
                $resultado = $personascontroller->InsertarPersonaUsuario($nombre, $apellido, $cedula, $telefono, $correo, $sexo, $direccion, $f_nacimiento, $estatus,  $segundo_nombre, $segundo_apellido);
    ...
    <div class="bg-white rounded h-25 p-4" style="width: 50%; margin:auto;">
        ...
        <center><h1>Insertar Persona</h1></center>
        ...
        <form method="POST">
            ...
            <div class="form-floating mb-3">
                <button class="btn btn-outline-success" type="submit">Insertar Persona. <i class="fa fa-check"></i></button>
